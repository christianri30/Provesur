...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function(element){
        orderList.add({
            id: '<a href="OrderDetails" class="fw-medium link-primary">#VZ'+element.id+'</a>',
    ...
    orderList.remove("id", `<a href="OrderDetails" class="fw-medium link-primary">#VZ2101</a>`);
}
        ...
        if (!form.checkValidity()) {
            ...
            event.preventDefault();
                if (
                    ...
                    orderList.add({
                        id: '<a href="OrderDetails" class="fw-medium link-primary">#VZ'+count+"</a>",
